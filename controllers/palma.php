...
<head>
    ...
    <title> Travel and Time - Palma </title>
        ...
        <section>
            <article>
				...
				<div class="responsive">
					<div class="gallery">
						<a href='#alham'><img src="../img/palma2.jpg" alt="Cinque Terre" width="600" height="400"></a>
					<div class="desc">
					
					<h6>Palma: Lugares de Interés</h6>
					
					<p>5 días / 4 noches recorriendo la Palma. Se realizará un recorrido por sus zonas y lugares de interés.</p>
					<input type="text" name="dest1" id="dest1" value="Palma: Sol y Playa" hidden>
					<input type="text" name="pre1" id="pre1" value="290" hidden>
					<input type="submit" name="r1" class="btn btn-warning" value="RESERVA YA">
					<p>Precio:</p><h4 class="precio">290€</h4> 
				...
				<div class="responsive">
					<div class="gallery">
						<a href='#sierra'><img src="../img/palma.jpg" alt="Cinque Terre" width="600" height="400"></a>
					<div class="desc">
					
					<h6>Palma: Sol y Playa</h6>
					
					<p>7 días / 6 noches en Palma. Se organizarán recorridos por las playas de la isla. Visitas culturales incuidas.</p>
					<input type="text" name="dest2" id="dest2" value="Palma: Lugares de Interés" hidden>
					<input type="text" name="pre2" id="pre2" value="375" hidden>
					<input type="submit" name="r2" class="btn btn-warning" value="RESERVA YA">
					<p>Precio:</p><h4 class="precio">375€</h4> 
				...
				<div class="responsive">
					<div class="gallery">
						<img src="../img/palmamapa.jpg"" alt="Forest" width="600" height="400">
						
						<div class="desc">
						
							<p>Ubicación: Archipiélago Balear.</p>
				...
				<h5 id="alham">Palma: Lugares de Interés</h5>
 
				<p class="titu">Día 1: Origen - Palma:</p>
				...
				<p class="titu">Día 4: Excursión por la isla</p>
				...
				<p class="titu">Día 5. Palma - Origen</p>
				...
				<h5 id="sierra">Palma: Sol y Playa</h5>
				
				<p class="titu">Día 1: Ciudad de origen - Palma</p> 
				...
				<p class="titu">Día 3: Playas de Palma</p> 
				...
				<p class="titu">Día 7: Palma - Ciudad de origen</p> 
