...
<head>
    ...
    <title> Travel and Time - Sevilla </title>
        ...
        <section>
			...
			<div id="catalogo">
				...
				<div class="responsive">
					<div class="gallery">
						<a href='#alham'><img src="../img/sevilla2.jpg" alt="Cinque Terre" width="600" height="400"></a>
					<div class="desc">
					
					<h6>Sevilla: Lugares de Interés</h6>
					
					<p>7 días / 6 noches recorriendo la ciudad de Sevilla. Recorrido por los lugares de interés incuido.</p>
					
					<input type="text" name="dest1" id="dest1" value="Sevilla: Lugares de interes" hidden>
					<input type="text" name="pre1" id="pre1" value="340" hidden>
					<input type="submit" name="r1" class="btn btn-warning" value="RESERVA YA">
					<p>Precio:</p><h4 class="precio">340€</h4> 
				...
				<div class="responsive">
					<div class="gallery">
						<a href='#sierra'><img src="../img/sevilla.jpg" alt="Cinque Terre" width="600" height="400"></a>
					<div class="desc">
					
					<h6>Sevilla: Ruta del Betis</h6>
					
					<p>7 días / 6 noches recorriendo la ciudad de Sevilla. Recorrido por la ciudad y alrededores incuidos.</p>
					
					<input type="text" name="dest2" id="dest2" value="Sevilla: Ruta del Betis" hidden>
					<input type="text" name="pre2" id="pre2" value="425€" hidden>
					<input type="submit" name="r2" class="btn btn-warning" value="RESERVA YA">
					<p>Precio:</p><h4 class="precio">425€</h4> 
				...
				<div class="responsive">
					<div class="gallery">
						<img src="../img/sevillamapa.jpg"" alt="Forest" width="600" height="400">
				...
				<h5 id="alham">Sevilla: Lugares de Interés</h5>
 
				<p class="titu">Día 1: Origen - Sevilla</p>
				...
				<p class="titu">Día 4: Recorrido por Sevilla</p>
				...
				<p class="titu">Día 5: Sevilla - Origen:</p>
				...
				<h5 id="sierra">Sevilla: Ruta del Betis</h5>
				
				<p class="titu">Día 1: Ciudad de origen - Sevilla</p> 
				...
				<p class="titu">Día 3: Sevilla - Alrededores</p> 
				...
				<p class="titu">Día 6: Día Libre</p> 
				
				<p>Día libre. Alojamiento.</p> 

				<p class="titu">Día 7: Sevilla - Ciudad de origen</p> 
