...
<head>
    ...
    <title> Travel and Time - Málaga </title>
        ...
        <section>
            <article>
				...
				<div class="responsive">
					<div class="gallery">
						<a href='#alham'><img src="../img/malaga1.jpg" alt="Cinque Terre" width="600" height="400"></a>
					<div class="desc">
					
					<h6>Málaga: Costa del Sol</h6>
					
					<p>5 días / 4 noches recorriendo la ciudad de Málaga. Recorrido por la Costa del Sol incluida.</p>
					
					<input type="text" name="dest1" id="dest1" value="Málaga: Costa del Sol" hidden>
					<input type="text" name="pre1" id="pre1" value="420" hidden>
				...
				<div class="responsive">
					<div class="gallery">
						<a href='#sierra'><img src="../img/malaga.jpg" alt="Cinque Terre" width="600" height="400"></a>
					<div class="desc">
					
					<h6>Málaga: Ciudad de Interés</h6>
					
					<p>7 días / 6 noches en Málaga. Se organizarán varios recorridos por las calles de Málaga.</p>
					
					<input type="text" name="dest2" id="dest2" value="Málaga: Ciudad de Interés" hidden>
					<input type="text" name="pre2" id="pre2" value="325" hidden>
					<input type="submit" name="r2" class="btn btn-warning" value="RESERVA YA">
					<p>Precio:</p><h4 class="precio">325€</h4> 
				...
				<div class="responsive">
					<div class="gallery">
						<img src="../img/malagamapa.jpg"" alt="Forest" width="600" height="400">
				...
				<h5 id="alham">Málaga: Costa del Sol</h5>
 
				<p class="titu">Día 1: Origen - Málaga</p>
				...
				<p class="titu">Día 4: Recorrido Costa del Sol</p>
				...
				<p class="titu">Día 5. Málaga - Origen</p>
				...
				<h5 id="sierra">Málaga: Ciudad de Interés</h5>
				
				<p class="titu">Día 1: Ciudad de origen - Málaga</p>
				...
				<p class="titu">Día 3: Recorrido por Ciudad</p>
				...
				<p class="titu">Día 5: Costa del Sol</p>
				...
				<p class="titu">Día 7: Málaga - Ciudad de origen</p>
