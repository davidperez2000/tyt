...
<head>
    ...
    <title> Travel and Time - Granada </title>
        ...
        <section>
            <article>
				...
				<div class="responsive">
					<div class="gallery">
						<a href='#alham'><img src="../img/granada.jpg" alt="Cinque Terre" width="600" height="400"></a>
					<div class="desc">
					
					<h6>Granada: La Alhambra</h6>
					
					<p>5 días / 4 noches recorriendo la ciudad de Granada. Recorrido por La Alhambra y alrededores incuidos.</p>
					<input type="text" name="dest1" id="dest1" value="Granada : La Alhambra" hidden>
				...
				<div class="responsive">
					<div class="gallery">
						<a href='#sierra'><img src="../img/sierranevada.jpg" alt="Cinque Terre" width="600" height="400"></a>
					<div class="desc">
					
					<h6>Granada: Sierra Nevada</h6>
					<p>7 días / 6 noches en Granada. Se organizarán recorridos por las rutas de Sierra Nevada. Visitas culturales incuidas.</p>
					<input type="text" name="dest2" id="dest2" value="Granada : Sierra Nevada" hidden>
					<input type="text" name="pre2" id="pre2" value="350" hidden>
					<input type="submit" name="r2" class="btn btn-warning" value="RESERVA YA">
					<p>Precio:</p><h4 class="precio">350€</h4> 
				...
				<div class="responsive">
					<div class="gallery">
						<img src="../img/granadamapa.jpg"" alt="Forest" width="600" height="400">
						
						<div class="desc">
						
							<p>Ubicación: Sur de España.</p>
				...
				<h5 id="alham">Granada: La Alhambra</h5>
 
				<p class="titu">Día 1: Origen - Granada</p>
				...
				<p class="titu">Día 2: Granada</p>

				<p>Desayuno. Excursión a Granada, la ciudad más importante del sur de Andalucía. Visitaremos el Mirador del Castro, donde tendremos una panorámica perfecta de la ciudad. Regreso al hotel para el almuerzo. Tarde libre con posibilidad de realizar excusión opcional a la Comarca de O Salnés y Cambados, con visita a bodega denominación Rías Baixas con degustación de vino albariño. Cena y alojamiento.</p>

				<p class="titu">Día 3: Día libre</p>
				...
				<p class="titu">Día 4: Isla de la Toja - Combarro</p>
				...
				<p class="titu">Día 5. Granada - Origen</p>
				...
				<h5 id="sierra">Granada: Sierra Nevada</h5>
				
				<p class="titu">Día 1: Ciudad de origen - Granada</p>
				...
				<p class="titu">Día 3: Granada - Sierra Nevada</p> 
				...
				<p class="titu">Día 4: Sierra Nevada</p> 
				
				<p>Día libre. Alojamiento.</p> 

				<p class="titu">Día 5: Sierra Nevada</p> 
				
				<p>Día libre. Alojamiento.</p> 

				<p class="titu">Día 6: Sierra Nevada</p> 
				
				<p>Día libre. Alojamiento.</p> 

				<p class="titu">Día 7: Sierra Nevada - Ciudad de origen</p> 
